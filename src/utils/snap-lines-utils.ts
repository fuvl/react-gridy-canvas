...
export function calculateDistanceSnapTargets(
  ...
  const checkHorizontalAlignment = (alignmentCheck: (item1: GridItem, item2: GridItem, dragging: GridItem) => boolean) => {
  ...
  checkHorizontalAlignment((item1, item2, dragging) => {
    ...
    return Math.abs(item1CenterY - draggingCenterY) <= distanceSnapThreshold && 
  ...
  if (snapX === null) {
    checkHorizontalAlignment((item1, item2, dragging) => {
      return Math.abs(item1.y - dragging.y) <= distanceSnapThreshold && 
  ...
  if (snapX === null) {
    checkHorizontalAlignment((item1, item2, dragging) => {
      ...
      return Math.abs(item1Bottom - draggingBottom) <= distanceSnapThreshold && 
  ...
  if (snapX === null) {
    checkHorizontalAlignment((item1, item2, dragging) => {
      ...
      return (Math.abs(item1Bottom - item2Top) <= distanceSnapThreshold || 
  ...
  const checkVerticalAlignment = (alignmentCheck: (item1: GridItem, item2: GridItem, dragging: GridItem) => boolean) => {
  ...
  checkVerticalAlignment((item1, item2, dragging) => {
    ...
    return Math.abs(item1CenterX - draggingCenterX) <= distanceSnapThreshold && 
  ...
  if (snapY === null) {
    checkVerticalAlignment((item1, item2, dragging) => {
      return Math.abs(item1.x - dragging.x) <= distanceSnapThreshold && 
  ...
  if (snapY === null) {
    checkVerticalAlignment((item1, item2, dragging) => {
      ...
      return Math.abs(item1Right - draggingRight) <= distanceSnapThreshold && 
  ...
  if (snapY === null) {
    checkVerticalAlignment((item1, item2, dragging) => {
      ...
      // Check if any combination of edges align
      return (Math.abs(item1Right - item2Left) <= distanceSnapThreshold || 
